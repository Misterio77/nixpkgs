...
- [PhotoPrism](https://photoprism.app), a self-hosted server-based application
  for browsing, organizing, and sharing your personal photo collection.
  Available as
  [services.photoprism](options.html#opt-services.photoprism.enable).
